    ...
    return (
        <div className='p-10 flex flex-col md:flex-row  lg:flex-row justify-between gap-20 items-center'>
            ...
            <div className='sm:w-full md:w-1/2 space-y-4 '>
                ...
                <p>The technological revolution is changing aspect of our lives, and the fabric of society itself. it is also changing the way we learn and what we learn. Factual knowledge is less prized when everything you ever need to know can be found on your phone. There is no imperative to be an expert at doing everything when you can.</p>
